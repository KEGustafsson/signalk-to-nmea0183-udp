...
export default function PluginConfigurationPanel({
  ...
  return (
    <div style={S.root}>
      <div style={S.desc}>
        Select which NMEA 0183 sentences to generate from Signal K data and send
        to the UDP destination below. A sentence is only sent when all its
        required paths have data.
      </div>

      <div style={S.card}>
        <div style={S.pathLabel}>UDP output</div>
        <div style={S.fields}>
          <div style={S.field}>
            <label style={S.fieldLabel}>UDP address</label>
            <input
              style={S.input}
              type="text"
              value={udpAddress}
          ...
          <div style={S.field}>
            <label style={S.fieldLabel}>UDP port</label>
            <input
              style={S.input}
              type="number"
              min={1}
